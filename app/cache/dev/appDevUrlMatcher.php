...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/blog')) {
            ...
            // sdzblog_recherche
            if (0 === strpos($pathinfo, '/blog/recherche') && preg_match('#^/blog/recherche/(?P<motif>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'sdzblog_recherche')), array (  '_controller' => 'Sdz\\BlogBundle\\Controller\\BlogController::rechercheAction',));
            }
